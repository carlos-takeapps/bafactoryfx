...
using BAFactory.Fx.Security.Areas.Membership.Controllers;
using BAFactory.Fx.Security.MembershipProvider;
using BAFactory.Fx.Security.Models;
using BAFactory.Fx.Security.MVCExtension;
using System.Web.SessionState;

namespace BAFactory.Fx.Security.Controllers
{
    public class AccountController : MembershipSessionInfoController
    {
